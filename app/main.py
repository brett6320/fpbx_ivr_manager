...
from app.audit_mw import ActivityLogMiddleware, ClientIPMiddleware
...
# Outermost: resolve the proxy-aware client IP into a ContextVar before anything
# else runs, so every audit entry can stamp it.
